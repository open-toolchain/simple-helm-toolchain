...
* **First-time IBM Container Service users**: Make sure that your container image registry is correctly set up with a [namespace](https://console.bluemix.net/docs/services/Registry/index.html)
    IMPORTANT NOTE: For the pipeline to be able to build containers successfully, you need to ensure you did actually create your registry namespace with this sequence of actions.
        bx login
        bx target --cf
